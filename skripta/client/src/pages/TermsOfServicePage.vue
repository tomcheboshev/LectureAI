<template>
  <div class="bg-slate-50 dark:bg-canvas-dark text-slate-900 dark:text-white min-h-screen">
    ...
    <article class="max-w-3xl mx-auto px-6 pt-8 pb-24">
      <h1 class="font-display font-extrabold text-4xl mb-4">{{ t("marketing.nav.terms") }}</h1>
      ...
      <div class="rich-content-block" v-html="renderMarkdown(termsMd)"></div>
    </article>
...
const crumbs = [
  ...
  { label: t("marketing.nav.terms"), path: "/terms" },
];
